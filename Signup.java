...
public class Signup extends javax.swing.JFrame {
    String name,age,gender,contact,email,branch;
    public Signup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Your Branch", "CSE", "ECE", "ME", "ICE", "ENC", "CE", "BIOTECH" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Profile s = new Profile(name, age, gender, branch, contact, email);
        s.setVisible(true);
        setVisible(false);
